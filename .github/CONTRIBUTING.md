# Contributing to lir-agent

We welcome you to [check the existing issues](https://github.com/Shtirmann/lir-agent/issues) for bugs or enhancements to work on.
If you have an idea for an extension to lir-agent, please [file a new issue](https://github.com/Shtirmann/lir-agent/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/Shtirmann/lir-agent/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/lir-agent.git
   ```
...
Finally, go to the web page of your fork of the lir-agent repo, and click
...
If your contribution changes lir-agent in any way:

- Update the [documentation]("") so all of your changes are reflected there.

- Update the [README](https://github.com/Shtirmann/lir-agent/tree/master/README.md) if anything there has changed.
